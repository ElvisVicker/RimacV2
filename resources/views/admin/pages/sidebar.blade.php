<nav class="page-sidebar" id="sidebar">
        ...
        <ul class="side-menu metismenu">
            {{-- <li>
                <a href="{{ route('admin.chart') }}" style="display:flex; gap:8px;">
                    ...
                    <span class="nav-label"> Go to Home Page</span>
 ...
 --}}
            ...
            <li>
                <a href="{{ route('admin.buyer.index') }}" style="display:flex; gap:8px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6" style="width: 20px; height: 20px;">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.buy_order.index') }}" style="display:flex; gap:8px;">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5"
                        stroke="currentColor" class="w-6 h-6" style="width: 20px; height: 20px;">
                        <path stroke-linecap="round" stroke-linejoin="round"
            ...
            <li>
                <a href="{{ route('admin.car.index') }}" style="display:flex; gap:8px;">
                    ...
                    <span class="nav-label">Car</span><i class="fa fa-angle-left arrow"></i>
                </a>
            </li>
            ...
            <li>
                <a href="{{ route('admin.car_category.index') }}" style="display:flex; gap:8px;">
                    ...
                    <span class="nav-label"> Car
                        Category</span><i class="fa fa-angle-left arrow"></i>
                </a>
